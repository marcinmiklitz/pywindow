...
case_2 = {
    'elements': np.array([
        'O', 'O', 'O', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N',
        'N', 'N', 'N', 'C', 'H', 'C', 'H', 'H', 'C', 'H', 'H', 'C', 'H',
        'C', 'C', 'H', 'C', 'C', 'H', 'H', 'C', 'H', 'H', 'C', 'H', 'C',
        'C', 'H', 'C', 'C', 'H', 'H', 'C', 'H', 'H', 'C', 'H', 'O', 'O',
        'O', 'O', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N',
        'N', 'C', 'H', 'C', 'H', 'H', 'C', 'H', 'H', 'C', 'H', 'C', 'C',
        'H', 'C', 'C', 'H', 'H', 'C', 'H', 'H', 'C', 'H', 'C', 'C', 'H',
        'C', 'C', 'H', 'H', 'C', 'H', 'H', 'C', 'H', 'O', 'O', 'O', 'O',
        'C', 'C', 'C', 'C'
    ], ),
    'coordinates': np.array([
        [ 6.485,  1.614,  9.265],
...
case_3 = {
    'elements': np.array([
        'C', 'C', 'H', 'C', 'C', 'H', 'C', 'C', 'H', 'C', 'C', 'H', 'C',
        'H', 'C', 'C', 'H', 'C', 'H', 'C', 'C', 'H', 'C', 'H', 'C', 'C',
        'H', 'C', 'H', 'C', 'C', 'H', 'C', 'H', 'C', 'C', 'H', 'C', 'H',
...
case_5 = {
    'elements': np.array([
        'C', 'H', 'C', 'H', 'H', 'C', 'H', 'C', 'H', 'H', 'C', 'H', 'C',
        'H', 'H', 'C', 'H', 'C', 'C', 'C', 'C', 'H', 'C', 'C', 'H', 'C',
        'C', 'H', 'H', 'H', 'C', 'H', 'H', 'H', 'C', 'H', 'H', 'H', 'C',
        'H', 'C', 'H', 'C', 'H', 'H', 'C', 'H', 'C', 'H', 'H', 'C', 'H',
        'C', 'H', 'H', 'C', 'H', 'C', 'C', 'C', 'C', 'H', 'C', 'C', 'H',
        'C', 'C', 'H', 'H', 'H', 'C', 'H', 'H', 'H', 'C', 'H', 'H', 'H',
        'C', 'H', 'C', 'C', 'C', 'C', 'H', 'C', 'C', 'H', 'C', 'C', 'H',
        'H', 'H', 'C', 'H', 'H', 'H', 'C', 'H', 'H', 'H', 'C', 'H', 'C',
        'H', 'N', 'N', 'N', 'N', 'N', 'N', 'O', 'H', 'O', 'H', 'O', 'H',
        'C', 'H', 'C', 'H', 'H', 'C', 'H', 'C', 'H', 'H', 'C', 'H', 'C',
        'H', 'H', 'C', 'H', 'C', 'C', 'C', 'C', 'H', 'C', 'C', 'H', 'C',
        'C', 'H', 'H', 'H', 'C', 'H', 'H', 'H', 'C', 'H', 'H', 'H', 'C',
        'H', 'C', 'H', 'C', 'H', 'H', 'C', 'H', 'C', 'H', 'H', 'C', 'H',
...
results_2 = {
    "windows_diam":
    np.array([3.72937988, 3.34146021]),
    "windows_coms":
    np.array(
        [
...
results_3 = {
    "windows_diam":
    np.array([6.5036498, 7.90390212, 7.26955977]),
    "windows_coms":
    np.array(
        [
...
results_5 = {
    "windows_diam":
    np.array([
        9.05947325, 9.17248589, 9.17507442, 9.16546517, 9.19219132, 9.05399606
    ]),
    "windows_coms":
    np.array(
        [
...
class TestWindows(unittest.TestCase):
    """Validating finding windows (diameters, COMs, Total number found)."""
    ...
    def _test_case_1_new(self):
        ...
        molsys = pw.MolecularSystem.load_system(case_1, 'case_1')
        mol = molsys.system_to_molecule()
        self.assertIsNone(mol.get_windows())
    ...
    def _test_case_2_new(self):
        ...
        com = np.array(
            [window.calculate_centre_of_mass() for window in windows])
